...
declare global {
  ...
  const useAuthenticate: typeof import('../../composables/state')['useAuthenticate']
...
declare module 'vue' {
  interface ComponentCustomProperties {
    ...
    readonly useAuthenticate: UnwrapRef<typeof import('../../composables/state')['useAuthenticate']>
